            ...
            <div className="hero bg-base-200 rounded-lg">
                <div className="hero-content py-8 md:py-14 max-w-full flex flex-col lg:flex-row">
                    ...
                    <div className="text-center w-full lg:w-2/5 mt-4 lg:mt-0">
                        ...
                        <Link to="/alltoys">
                            <button className="inline-block text-sm px-4 py-2 leading-none border rounded text-black border-gray-600 hover:text-gray-400 hover:border-gray-200 mt-4 lg:mt-0">All Toys</button>
                        </Link>
                    </div>
                </div>
            </div>
